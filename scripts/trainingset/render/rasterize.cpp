...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  //declare variables
  mxArray *a_in_m, *b_in_m, *c_in_m, *d_in_v, *e_out_m, *f_out_m;
  double *triangle_list, *vertices, *color, *resolution, *frame_buffer, *t_buffer;
  ...
  f_out_m = plhs[1] = mxCreateDoubleMatrix((int)resolution[0],(int)resolution[1],mxREAL);
  
  //associate pointers to the data in the output mxArray
  frame_buffer = mxGetPr(e_out_m);
  t_buffer = mxGetPr(f_out_m);
